...
const tribunais = [
    ...
    // PARANÁ — PR
    // ==========================================
    { id: "tjpr_eproc_1g", nome: "TJPR - eproc 1º Grau", sub: "Servidor eproc 1º Grau",       grupo: "PR", lote: 1, url: "https://eproc.tjpr.jus.br/eproc1g/" },
    { id: "tjpr_eproc_2g", nome: "TJPR - eproc 2º Grau", sub: "Servidor eproc 2º Grau",       grupo: "PR", lote: 1, url: "https://eproc.tjpr.jus.br/eproc2g/" },
    { id: "tjpr_projudi",  nome: "TJPR - Projudi",       sub: "Servidor Projudi Login",        grupo: "PR", lote: 1, url: "https://projudi.tjpr.jus.br/projudi/" },
    { id: "trt9_1g",       nome: "TRT9 - PJe 1º Grau",  sub: "Servidor PJe PR (Varas)",       grupo: "PR", lote: 1, url: "https://pje.trt9.jus.br/pje/" },
    { id: "trt9_2g",       nome: "TRT9 - PJe 2º Grau",  sub: "Servidor PJe PR (Tribunal)",    grupo: "PR", lote: 1, url: "https://pje.trt9.jus.br/pje2g/" },
